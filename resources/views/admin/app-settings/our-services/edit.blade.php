...
<div class="panel panel-primary">
    ...
    <form role="form" class="form-horizontal" action="{{Route('our_services.update' , $serviceData->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        @if ($errors->any())
            ...
            <div class="col-md-6">
                    ...
                    <div class="col-sm-7">
                       <center>
                           <div class="fileinput-new thumbnail" style="height: 140px; width:140px">
                                <img id="previmage" src="{{$serviceData->icon ? '/' .$serviceData->icon :  '/assets/images/album-image-1.jpg'}}" width="140">
                            </div>
                        </center>
                ...
                <div class="form-group col-md-12">
                    <div class="col-sm-7">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="Enter Service Title" value="{{$serviceData->title}}">
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <div class="col-sm-12">
                        <label for="name" class="control-label">Serve Description</label>
                        <textarea type="text" class="form-control" id="description" name="description">{{$serviceData->description}}</textarea>
                    </div>
                </div>
            </div>
        </div>
