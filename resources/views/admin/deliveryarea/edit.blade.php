...
<div class="panel panel-primary">
    ...
    <form role="form" class="form-horizontal" action="{{route('delivery_area.update',$editData->id)}}" method="post">
        @csrf
        @method('put')
        @if ($errors->any())
            ...
            <div class="col-md-6">
                <div class="form-group col-md-12">
                    <div class="col-sm-7">
                        ...
                        <input type="text" class="form-control" value="{{$editData->area_name}}" id="area_name" name="area_name" placeholder="Enter Area Name">
                    </div>
                </div>
            </div>
                ...
                <div class="form-group col-md-12">
                    <div class="col-sm-7">
                        ...
                        <select type="text" class="form-control" id="zone_id" name="zone_id">
                            ...
                            <option {{$data->id == $editData->zone_id ? 'selected' :''}} value="{{$data->id}}">{{$data->zone_name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
