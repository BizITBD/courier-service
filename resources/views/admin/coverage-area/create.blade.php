...
<div class="panel panel-primary">
    ...
    <form role="form" class="form-horizontal" action="/admin/coverage_area" method="post">
        @csrf
        @if ($errors->any())
            ...
            <div class="col-md-6">
                ...
                <div class="form-group col-md-12">
                    <div class="col-sm-7">
                        ...
                        <input type="text" class="form-control" id="cod_charge" name="cod_charge" placeholder="Enter COD Charge">
                    </div>
                </div>
                <div class="form-group col-md-12">
                        <div class="col-sm-7">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group col-md-12">
                    <div class="col-sm-7">
                        ...
                        <input type="text" class="form-control" id="charge_1kg" name="charge_1kg" placeholder="Charge per 1 Kg">
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <div class="col-sm-7">
                        <label for="charge_2kg" class="control-label">Charge(2kg)</label>
                        <input type="text" class="form-control" id="charge_2kg" name="charge_2kg" placeholder="Charge per 2 Kg">
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <div class="col-sm-7">
                        <label for="charge_3kg" class="control-label">Charge(3kg)</label>
                        <input type="text" class="form-control" id="charge_3kg" name="charge_3kg" placeholder="Charge per 1 Kg">
                    </div>
                </div>
            </div>
        </div>
