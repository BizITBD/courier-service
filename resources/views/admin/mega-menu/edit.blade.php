...
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">Edit Mega Menu</div>
        <div class="panel-options">
            <a href="/admin/mega-menu"><button class="btn btn-success ">List</button></a>
        </div>
    </div>
    <form role="form" class="form-horizontal" action="{{Route('mega-menu.update',$editData->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('put')
        @if ($errors->any())
            ...
            <div class="col-md-6">
                <div class="form-group col-md-12">
                    <div class="col-sm-7">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title" value="{{$editData->title}}">
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <div class="col-sm-7">
                        <label for="subtitle" class="control-label">Subtitle*</label>
                        <input type="text" class="form-control" id="subtitle" name="subtitle" placeholder="Enter Sub Title" value="{{$editData->subtitle}}">
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <div class="col-sm-7">
                        <label for="header" class="control-label">Header*</label>
                        <input type="text" class="form-control" id="header" name="header" placeholder="Enter Header" value="{{$editData->header}}">
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <div class="col-sm-7">
                        <label for="icon" class="control-label">Mega Menu Icon</label>
                       ...
                       <center>
                            <div class="fileinput-new thumbnail" style="height: 140px; width:140px">
                                <img id="previmage" src="{{$editData->icon ? '/' . $editData->icon :  '/assets/images/album-image-1.jpg'}}" width="140">
                            </div>
                        </center>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group col-md-12">
                    <div class="col-sm-7">
                       ...
                       <center>
                           <div class="fileinput-new thumbnail" style="height: 140px; width:140px">
                                <img id="banner1" src="{{$editData->banner ? '/' . $editData->banner :  '/assets/images/album-image-1.jpg'}}" width="140">
                            </div>
                        </center>
                    </div>
                </div>
