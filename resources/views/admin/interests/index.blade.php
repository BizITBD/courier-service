    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            <div class="panel-options">
                <a href="{{Route('interests.create')}}"><button class="btn btn-success btn-sm" style="margin-top: 8%">Add New Interest</button></a>
            </div>
        </div>
        <div class="panel-heading">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center " style="display:flex; justify-content:center;">
                            ...
                            <a class="btn btn-xs {{$data->status == 1 ? 'btn-success' :' btn-warning'}}" href="interests/status/{{$data->id}}"><i class="entypo-arrows-ccw"></i></a>


                            <a href="/admin/interests/{{$data->id}}" data="{{$data->id}}" class="btn btn-xs btn-danger delete-confirm" id="delete" type="button" data=""><i class="entypo-trash"></i></a>
                        </td>
                        @endforeach
                    </tr>
                </tbody>
        ...
        if (value) {
            $.ajax({
                    ...
                    success: function (response) {
                        toastr.warning("Interest Deleted successfully", "!!!");
                        window.location.href = "/admin/interests";
