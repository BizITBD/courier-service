...
function showData(id) {
    // let id = $("#view").val()
    console.log(id)
    let url = "/admin/reseller-payment/history/" + id;
    $(".print-id").attr('href',"/admin/reseller-payment/history-print/"+id)
    $.ajax({
        type: "get",
        url: url,
        dataType: "json",
        success: function(response) {
            ...
            response.invoice_info.forEach(element => {
                ...
                <td class="text-center" id="name">${element.invoice_id}</td>
